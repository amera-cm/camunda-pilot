...
@Component(
    PilotProcessDefinitionKey.Keys.TRADE_NOMINATION_KEY + NotifyNominationRejection.ACTIVITY_ID)
@ParametersAreNonnullByDefault
public class NotifyNominationRejection implements ActivityDelegate {

  public static final String ACTIVITY_ID = "notifyNominationRejection";
  private static final Logger logger = LogManager.getLogger(NotifyNominationRejection.class);
  ...
  public void execute(DelegateExecution delegateExecution) throws Exception {
    logger.info(() -> "SEND NOTIFICATION: Nomination Rejected");
    delegateExecution.setVariable(
        TRADE_STATUS_VAR_KEY, TradesOps.TradeStatus.NOMINATION_REJECTED.value());
  }
}
