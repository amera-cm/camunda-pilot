...
@Component(
    PilotProcessDefinitionKey.Keys.TRADE_ACKNOWLEDGE_KEY
        + SetupTradeCreateListener.TASK_DEFINITION_KEY)
@ParametersAreNonnullByDefault
public class SetupTradeCreateListener extends BaseUserTaskCreateListener {

  public static final String TASK_DEFINITION_KEY = "setupTrade";

  private final UsersOps usersOps;

  public SetupTradeCreateListener(UsersOps usersOps) {
